...
function App() {
  ...
  const sleepQuality = selectedData.length ? selectedData[0].sleep_quality : '';
      ...
      <div className="main-content">
        ...
        <div className="graph-card">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={selectedData} margin={{ top: 20, right: 20, bottom: 20, left: 0 }}>
          ...
          <table className="details-table">
            ...
            <tbody>
              ...
              <tr className="total-row">
                ...
                <td style={{ color: getStepsColor(totalSteps) }}><strong>{totalSteps}</strong></td>
